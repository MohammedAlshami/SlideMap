...
const page = () => {
  return (
    <>
      ...
      <section className=' pt-28 pb-44 flex justify-center items-center '>
        <div className="w-full w-6/12 p-8 space-y-3 rounded-xl bg-base-200 dark:bg-gray-900 dark:text-gray-100">
          <h1 className="text-2xl font-bold text-center mb-14">Register</h1>
          ...
          <p className="text-xs text-center sm:px-6 dark:text-gray-400">already have an account?
            <a rel="noopener noreferrer" href="#" className="underline dark:text-gray-100">Sign in</a>
          </p>
        </div>
      </section>
    </>

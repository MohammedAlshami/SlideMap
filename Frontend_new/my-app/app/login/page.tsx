  ...
  return (
    <>
      ...
      <section className='pt-20 flex justify-center items-center '>
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-base-200 dark:bg-gray-900 dark:text-gray-100">
          <h1 className="text-2xl font-bold text-center mb-14">Login</h1>

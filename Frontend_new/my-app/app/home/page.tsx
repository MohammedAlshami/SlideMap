                  ...
                  <div className="space-y-6 sm:space-y-8">
                    <div className="space-y-2 md:space-y-4">
                      ...
                      <div className="text-gray-900 grid grid-col gap-12 text-lg">
                        <p>
                          SlideMap is an innovative project designed to address
                          the scarcity of landslide incident datasets by
                          leveraging cutting-edge technology. Through web
                          scraping, we gather real-time news data from across
                          the internet, allowing us to swiftly detect and
                          pinpoint landslide occurrences worldwide. Our platform
                          then visualizes these incidents on an interactive map,
                          providing invaluable insights into landslide-prone
                          areas.
                        </p>
                        <p>
                          At SlideMap, we're committed to enhancing awareness
                          and understanding of landslides, empowering
                          communities and authorities to take proactive measures
                          for disaster mitigation. Join us as we revolutionize
                          the landscape of landslide monitoring and mapping, one
                          incident at a time.
                        </p>
                      </div>
                    </div>
            ...
            >
              <div className="flex-auto p-4 md:p-6">
                <h3 className="text-xl text-white/[.9] group-hover:text-white">
                  ...
                  Explore More News On The Latest Landslides Incidents In Malaysia
                </h3>
              </div>
